...
<div class="align-middle inline-block shadow sm:rounded-lg">
 ...
 <Pagination
          ...
          :total="this.$store.state.collector.updated.total"
          :page="page"
...
export default {
   head () {
    return {
      title: 'Fee Updated List | Collector',
    }
  },
  ...
  data(){
    ...
    //   this.searchParams()
    // }  
     await this.$store.dispatch('collector/get_updated',{"page":this.page,"params":this.params,"id":this.$route.query.id})   
  },
 computed: {
    total() {
      return this.$store.state.collector.updated.results
    },
