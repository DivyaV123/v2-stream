...
<div class="text-right mt-0 mr-2 ml-0 px-1 py-1">
 ...
 <Pagination
          ...
          :total="this.$store.state.verifier.not_verified.total"
          :page="page"
...
export default {
  ...
  data(){
    ...
    if (this.date_selected == null&&this.$route.query.date){
     ...
     await this.$store.dispatch('verifier/getNotverified',{"page":this.page,"params":this.params,"bid":this.$route.query.bid})
    // else{
    //   this.searchParams()
    // }     
  },
 computed: {
    total() {
      return this.$store.state.verifier.not_verified.results
    },
