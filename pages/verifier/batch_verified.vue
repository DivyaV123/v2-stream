...
<div class="text-right mt-0 mr-2 ml-0 px-1 py-1">
       ...
       <td class="border  
        ...
        <!-- <td class="border  
             ...
             <button  class="
                    ...
                    text-xs
                    btn btn-glass
                    border border-info">{{bran.balance}}
            </button>
        </td> -->
        <td class="border  
                 border-black  
        ...
        <td class="border  
          ...
          <button class="inline-flex 
                         ...
                         font-extrabold 
                         rounded-md 
                         text-black  " v-if="bran.verified ==false" v-on:click="verify=true,rid=bran.id">Verify</button>
    </td>
    <td class="border  
             border-black  
               text-center 
 ...
 <Pagination
          ...
          :total="this.$store.state.verifier.batch_verified.total"
          :page="page"
...
export default {
  ...
  data(){
    ...
    await this.$store.dispatch('verifier/getBatchVerified',{"page":this.page,"params":this.params,"id":this.$route.query.id})
    // else{
    //   this.searchParams()
    // }     
  },
 computed: {
    total() {
      return this.$store.state.verifier.batch_verified.results
    },  
  },
   methods:{
          maskNumber(numbers)
