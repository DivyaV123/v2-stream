...
<div class="text-right mt-0 mr-2 ml-0 px-1 py-1">
 ...
 <Pagination
          ...
          :total="this.$store.state.verifier.batch_notupdated.total"
          :page="page"
...
export default {
   head () {
    return {
      title: 'Not updated List | Verifier',
    }
  },
  ...
  data(){
    ...
    await this.$store.dispatch('verifier/getBatchNotUpdated',{"page":this.page,"params":this.params,"id":this.$route.query.id})
    // else
    // {
    //   this.searchParams()
    // }     
 ...
 computed: {
    total() {
      return this.$store.state.verifier.batch_notupdated.results
    },
