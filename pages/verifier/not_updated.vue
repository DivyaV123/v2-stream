...
<div class="text-right mt-0 mr-2 ml-0 px-1 py-1">
 ...
 <Pagination
          ...
          :total="this.$store.state.verifier.not_updated.total"
          :page="page"
...
export default {
  ...
  data(){
    ...
    await this.$store.dispatch('verifier/getNotUpdated',{"page":this.page,"params":this.params,"bid":this.$route.query.bid})
    // else
 ...
 computed: {
    total() {
      return this.$store.state.verifier.not_updated.results
    },   
  },
   methods:{
            maskNumber(numbers){
