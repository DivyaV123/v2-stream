...
<div v-if="isOpen">
 ...
 <Pagination
          ...
          :total="this.$store.state.verifier.batch_updated.total"
          :page="page"
...
export default {
  ...
  data(){
    ...
    await this.$store.dispatch('verifier/getBatchUpdated',{"page":this.page,"params":this.params,"id":this.$route.query.id})
    // else
    // {
    //   this.searchParams()
    // }     
 ...
 computed: {
    total() {
      return this.$store.state.verifier.batch_updated.results
    },  
  },
   methods:{
          maskNumber(numbers)
