...
<div
                  ...
                  <validation-observer ref="observer" v-slot="{ handleSubmit }">
                    ...
                    <div class="border border-white pt-3 pr-4 pl-4 pb-6">
                            <label for="country" class="block text-sm font-extrabold text-blue-5000">Reason</label>
                                    ...
                                    <v-select
                                        class="border border-white text-sm selected  selected"
                                        label="name"
                                        v-model="reason"
 ...
 <Pagination
          ...
          :total="this.$store.state.tracker.total_promised.total"
          :page="page"
...
export default {
   head () {
    return {
      title: 'Total Promised  List | Tracker',
    }
  },
  ...
  data(){
    ...
    await this.$store.dispatch('tracker/getTotalPromised',{"page":this.page,"params":this.params,"id":this.$route.query.id})
    // else
    // {
    //   this.searchParams()
    // }     
 ...
 computed: {
    total() {
      return this.$store.state.tracker.total_promised.results
    }, 
  },
   methods:{
