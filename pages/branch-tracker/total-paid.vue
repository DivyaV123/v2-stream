...
<div class="align-middle inline-block shadow sm:rounded-lg">
 ...
 <Pagination
          ...
          :total="this.$store.state.tracker.total_paid.total"
          :page="page"
...
export default {
  ...
  data(){
    ...
    await this.$store.dispatch('tracker/getTotalPaid',{"page":this.page,"params":this.params,"id":this.$route.query.id})
 ...
 computed: {
    total() 
    {
      return this.$store.state.tracker.total_paid.results
    }, 
  },
   methods:{
