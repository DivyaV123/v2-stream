...
<div class="container flex"  >
 ...
 <Pagination
          ...
          :total="this.$store.state.tracker.total_notpaid.total"
          :page="page"
...
export default {
   head () {
    return {
      title: 'Total not Paid List | Tracker',
    }
  },
  ...
  data(){
    ...
    await this.$store.dispatch('tracker/getTotalNotPaid',{"page":this.page,"params":this.params,"id":this.$route.query.id})
 ...
 computed: {
    total() {
      return this.$store.state.tracker.total_notpaid.results
    },
