...
<div class="container flex"  >
 ...
 <Pagination
          ...
          :total="this.$store.state.tracker.total_attended.total"
          :page="page"
...
export default {
   head () {
    return {
      title: 'Total attended List | Tracker',
    }
  },
  ...
  data(){
    ...
    await this.$store.dispatch('tracker/getTotalAttended',{"page":this.page,"params":this.params,"id":this.$route.query.id})  
  },
 computed: {
    total() {
      return this.$store.state.tracker.total_attended.results
    },
