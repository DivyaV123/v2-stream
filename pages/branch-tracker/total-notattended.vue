...
<div class="container flex"  >
 ...
 <Pagination
          ...
          :total="this.$store.state.tracker.total_notattended.total"
          :page="page"
...
export default {
   head () {
    return {
      title: 'Total not attended List | Tracker',
    }
  },
  ...
  data(){
    ...
    await this.$store.dispatch('tracker/getTotalNotAttended',{"page":this.page,"params":this.params,"id":this.$route.query.id})
    // else
    // {
    //   this.searchParams()
    // }     
 ...
 computed: {
    total() {
      return this.$store.state.tracker.total_notattended.results
    },
