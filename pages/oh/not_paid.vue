  ...
  <section class="mr-4">
    ...
    <table class="border-collapse border border-black border-3 border-opacity-50  w-full table-auto m-3 mr-36">
      ...
      <Pagination
        ...
        :total="this.$store.state.oh.not_paid.total"
        :page="page"
...
export default {
  ...
  data(){
    ...
    await this.$store.dispatch('oh/getNotPaid',{"page":this.page,"params":this.params,"id":this.$route.query.id,"bid":this.$route.query.bid})
    // else{
    //   this.searchParams()
    // }
  },
  computed: {
    total() {
      return this.$store.state.oh.not_paid.results
    },
