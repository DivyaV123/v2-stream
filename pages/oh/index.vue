  ...
  <section class="mr-4">
    <div class="mt-1 mx-1">
      ...
      <table class="border-collapse border border-white border-3 border-opacity-50  w-full table-auto m-3 mr-36">
        <thead>
          <tr class="leading-6">
            <th class="border  border-white  bg-gray-800 text-white" rowspan="2">Branch</th>
            <th class="border  border-white  bg-gray-800 text-white" rowspan="2">Batches</th>
          ...
          <tbody class="leading-4 bg-gray-400">
            <tr v-for="(bran, index) in branches" :key=index :class="{ 'bg-gray-500': index % 2}"> 
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold text-center has-tooltip7" >
                <NuxtLink class="hover:text-black-500" 
                          :to="bran.batches > 0 ?`/oh/batch?id=${bran.id}&date=${date.date}`:''" 
                          :target="bran.batches > 0 ? '_blank' : ''"  > 
                  <div class="leading-5 text-black uppercase  font-extrabold ">
                    <span v-if="bran.batches>0" class='tooltip7 shadow-l bg-black border border-white text-white mt-4 p-1 rounded-md text-sm'>click</span>
                    {{bran.batches}}
                  </div>
                </NuxtLink> 
              </td>
            ...
            <!-- <NuxtLink class="hover:text-black-500" :to="`/verifier/updated?id=${bran.id}&date=${date.date}`"> -->
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500" 
                          :to="bran.notpaid > 0 ?`/oh/not_paid?bid=${bran.id}&date=${date.date}`:''" 
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.partial > 0 ?`/oh/partial_paid?bid=${bran.id}&date=${date.date}`:''" 
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.paid > 0 ?`/oh/total_paid?bid=${bran.id}&date=${date.date}`:''"
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.total > 0 ?`/oh/total?bid=${bran.id}&date=${date.date}`:''"
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.signed > 0 ?`/oh/signed?bid=${bran.id}&date=${date.date}`:''"
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.profile > 0 ?`/oh/profile?bid=${bran.id}&date=${date.date}`:''"
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.dataverified > 0 ?`/oh/data_verify?bid=${bran.id}&date=${date.date}`:''"
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.updatedv1 > 0 ?`/oh/updated?bid=${bran.id}&date=${date.date}`:''"
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.notupdatedv1 > 0 ?`/oh/not_updated?bid=${bran.id}&date=${date.date}`:''" 
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.verified > 0 ?`/oh/verfied?bid=${bran.id}&date=${date.date}`:''" 
              ...
              <td class="px-2 py-1 whitespace-nowrap border border-indigo-100  font-semibold has-tooltip7 text-center" >
                <NuxtLink class="hover:text-black-500 " 
                          :to="bran.notverified > 0 ?`/oh/not_verified?bid=${bran.id}&date=${date.date}`:''"  
        ...
        <template v-else>
          <tbody>
            <tr>
              <td colspan="11" class="text-warning text-center">No Data</td>
            </tr>
          </tbody>
        </template>
      </table>
      <Pagination
        ...
        :total="this.$store.state.oh.branches.total"
        :page="page"
...
export default {
  ...
  async fetch(){
    ...
    await this.$store.dispatch('oh/getBranch',{"page":this.page,"params":this.params})
  ...
  computed: {
    branches() {
      return this.$store.state.oh.branches.results
    },
  },
  methods:{    
    onPageChange(page) {
