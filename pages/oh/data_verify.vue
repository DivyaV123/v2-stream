  ...
  <section class="mr-4">
    <div class="mt-1 mx-1">
      ...
      <Pagination
        ...
        :total="this.$store.state.oh.data_verify.total"
        :page="page"
...
export default {
  ...
  async fetch(){
    ...
    await this.$store.dispatch('oh/getDataVerify',{"page":this.page,"params":this.params,"id":this.$route.query.id,"bid":this.$route.query.bid})
    // else{
    //   this.searchParams()
    // }
  },
  computed: {
    total() {
      return this.$store.state.oh.data_verify.results
    },
  },
  methods:{
    maskNumber(numbers){
