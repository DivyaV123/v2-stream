<template>
  <section class="mr-4">
    ...
    <Pagination
            ...
            :total="this.$store.state.oh.paid.total"
            :page="page"
...
export default {
  ...
  async fetch(){
    ...
    await this.$store.dispatch('oh/getPaid',{"page":this.page,"params":this.params,"id":this.$route.query.id,"bid":this.$route.query.bid})
    // else{
    //   this.searchParams()
    // }
  },
  computed: {
    total() {
      return this.$store.state.oh.paid.results
    }
  },
  methods:{
    maskNumber(numbers){
