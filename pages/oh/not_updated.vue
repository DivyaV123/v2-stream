<template>
  <section class="mr-4">
    ...
    <Pagination
              ...
              :total="this.$store.state.oh.not_updated.total"
              :page="page"
...
export default {
  ...
  async fetch(){
    await this.$store.dispatch('oh/getNotUpdated',{"page":this.page,"params":this.params,"id":this.$route.query.id,"bid":this.$route.query.bid})
  ...
  computed: {
    total() {
      return this.$store.state.oh.not_updated.results
    },
  },
  methods:{
    maskNumber(numbers){
