<template>
  <div class="">
    <div class="flex justify-between w-full prose lg:prose-xl">
      <span class="btn btn-xs btn-success btn-outline ">
        <span class="text-xs">
          Current Page - {{ page }}
        </span> 
      </span>
      <h3 class="text-success prose lg:prose-xl text-2xl">Batch Student Verfication</h3>
      <button @click="isSearch = !isSearch" class="btn btn-outline btn-success btn-xs text-xs">Search</button>
    </div>
    <div v-if="isSearch">
      ...
      <table class="table w-full table-auto table-compact table-zebra">
        <thead>
          <tr class="border">
            ...
            <th></th>
            <th></th>
            <th colspan="4" class="border">Total Students</th>
            <th></th>
            <th></th>
            <th></th>
            <th></th>
